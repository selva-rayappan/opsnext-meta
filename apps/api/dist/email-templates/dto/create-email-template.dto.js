...
class CreateEmailTemplateDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, subject: { required: true, type: () => String }, bodyHtml: { required: true, type: () => String }, isShared: { required: false, type: () => Boolean } };
    }
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Visible to all org members when true (default: true)' }),
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
], CreateEmailTemplateDto.prototype, "isShared", void 0);
